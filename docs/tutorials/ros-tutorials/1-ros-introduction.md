...
Another option is to use **virtual machine** or **ROS native installation**, this requires Ubuntu 18.04 operating system and you will have to install ROS with Gazebo according to this <a href="http://wiki.ros.org/melodic/Installation/Ubuntu">guide</a>. Native installation but will offer much better performance camparing to virtual machine.
